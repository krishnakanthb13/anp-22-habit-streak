 ...
 * All habits follow a daily cadence.
 * @param {object} habit - Habit object.
 * @param {string} dateStr - YYYY-MM-DD
 * @param {string} [refStartStr] - Reference tracking start date (YYYY-MM-DD).
 * @param {boolean} [allowBackdated=false] - Whether to allow dates before habitStart.
 * @returns {boolean}
 */
 ...
 * Prioritizes temporal bounds (future -> before_start) before checking records.
 * @param {object} habit - Habit object.
 * @param {string} dateStr - YYYY-MM-DD
...
export function getHabitDayStatus(habit, dateStr, todayStr = getTodayString(), cachedSets = null, effectiveStartStr = null) {
  ...
  // Quitting / Bad habit (skip-tracked): clean unless explicitly skipped/slipped
  return "completed";
}

/**
 * Calculates current streak, longest streak, and stats for a habit.
 * Evaluates contiguous daily tracking.
 * @param {object} habit - Habit object.
