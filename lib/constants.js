...
export const TRACK_TYPES = {
  SKIP: "skip", // Quitly default: habit is done unless explicitly marked skipped (Abstinence)
  COMPLETE: "complete" // Amplenote default: habit is not done unless explicitly completed (Positive Action)
};
